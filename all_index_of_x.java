...
public class all_index_of_x {
    ...
    {// If the start index reaches the
        ...
        if (input[start] == x) {
            int[] myAns = new int[smallIndex.length + 1];// Put the start index in front
            // of the array
            myAns[0] = start;
            for (int i = 0; i < smallIndex.length; i++) {// Shift the elements of the array
        ...
        else {// If the element at start index is not
    ...
    public static void main(String []args){
        ...
        System.out.println(allIndexes(input,8));
